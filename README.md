...
* **Classic ASCII Graphics:** The dungeon, entities, and UI are rendered entirely within the terminal.
* **Custom Game Engine:** Implements a standard `Input -> Update -> Render` game loop.
...
* **Grid-Based Movement:** 2D array map generation with coordinate-based collision detection.
